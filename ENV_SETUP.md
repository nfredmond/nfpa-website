...
# Model is fixed in code to provider-native: gpt-5.3-instant
...
- Homepage AI planner chatbot and Grant Lab both use `OPENAI_API_KEY` and are pinned to `gpt-5.3-instant` (OpenClaw alias equivalent: `openai-codex/gpt-5.3-instant`).
